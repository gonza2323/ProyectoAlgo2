...
#usamos solo dos vectores fila en lugar de una matriz
#se coloca la palabra mas corta de forma horizontal y la mas larga en vertical
    ...
    #definimos dos vectores fila: prev y current, que serán de tamaño len_str_corta
    ...
    for i in range(1, len_str_larga + 1):
        ...
        for j in range(1, len_str_corta + 1):
            ...
            if str_corta[j-1] != str_larga[i-1]: #si los caracteres son iguales no se requiere hacer ninguna operación (add, delete, change)
                change += 1 
